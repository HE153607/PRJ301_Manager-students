...
public class recover extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Properties p=new Properties();
                    ...
                    m.setRecipients(Message.RecipientType.TO, "anhnhhe153607@fpt.edu.vn");
                    m.setSubject("recover password");
                    m.setContent("<h1>Your Password:</h1>"
                    ...
                    Transport.send(m,"anhh34711@gmail.com","@hoanganh12345@");}
        catch(Exception e){
            System.out.println("loi r");
        }
                    //request.setAttribute("er", "Password sent to "+"a");
