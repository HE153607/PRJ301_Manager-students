...
public final class checkdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <select onchange=\"document.getElementById('djk').submit()\" name=\"id\">\n");
      out.write("                ");
 ...
 for(int i=0;i<((ArrayList<String>)request.getAttribute("listteacher")).size();i++){
      out.write("\n");
      out.write("                <option ");
if(request.getParameter("id")!=null&&request.getParameter("id").trim().equals(((ArrayList<String>)request.getAttribute("listteacher")).get(i).split("=")[0])){
      out.print("selected");
 }
      out.write(" value=\"");
      out.print( ((ArrayList<String>)request.getAttribute("listteacher")).get(i).split("=")[0] );
      out.write('"');
      out.write('>');
      out.print( ((ArrayList<String>)request.getAttribute("listteacher")).get(i).split("=")[1] );
      out.write("</option>\n");
      out.write("                ");
 }
      out.write("\n");
 ...
 if (request.getAttribute("list") == null) {
      ...
      out.write("            <table>\n");
      out.write("                <tr>\n");
      out.write("                    <th style=\"background-color: #ffffff;\"></th>\n");
      out.write("                        ");
 SimpleDateFormat s = new SimpleDateFormat("dd-MM-yyyy");
      ...
      out.write("                    <th >\n");
      out.write("                        ");
      out.print( s1.format(s.parse(a.get(i))));
      out.write("<br/>\n");
      out.write("                        <p style=\"width: 100px;\"> ");
      out.print( s.format(s.parse(a.get(i))));
      out.write("</p>\n");
      out.write("                    </th>    \n");
      out.write("                    ");
 }
...
if (s.format(st.get(j).getDob()).equals(s.format(s.parse(a.get(i))))) {
  ...
  private boolean _jspx_meth_sql_query_0(PageContext _jspx_page_context)
    ...
    _jspx_th_sql_query_0.setSql((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("select djoin from datejoin where id='${studentid}'", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.id==null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<option>select name teacher</option>");
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${year==year1 and requestScope.year==null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.year!=null and requestScope.year==year}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${stt!=null and stt==count.count}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
