...
public class Schedule extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(request.getParameter(i+"")!=null&&!request.getParameter(i+"").trim().equals("")){
           if(request.getParameter(i+"").equals("absent"))c.insertattend(l.get(i).getId(), false, new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
           if(request.getParameter(i+"").equals("present"))c.insertattend(l.get(i).getId(), true, new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
         }
       else if(request.getParameter(i+"").equals("absent"))c.insertattend(l.get(i).getId(), false, new SimpleDateFormat("yyyy-MM-dd").format(new Date()));   
        }
