...
public class NewStudent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!idcard.equals("") && idcard.length() ==9 && !namep.equals("") && !phonep.equals("") && t != null && !name.equals("") && !phone.equals("")
                && !mail.equals("") && !address.equals("") && !code.equals("") && !date.equals("") && checkDate(date) && !idcard(c.getparents(), idcard)) {
            ...
            try {
                if (campus.equals(t.getCampus()) && t.getCode().equals(code)) {                    
                    ...
                    c.insertattend(id, false, new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
                    c.insertparent(new Parents(randomid2(c.getparents()), idcard, phonep, namep, id));
