        ...
        if(name!=null&&id!=null&&date!=null&&!name.trim().equals("")&&!date.trim().equals("")&&!id.trim().equals("")){
            ...
            if(t!=null){
                try{
                    ...
                    m.setFrom(new InternetAddress("your account email","app Manager Students"));// your account email
                    ...
                    + "<a style=\"text-align:center;background-color:green;text-decoration: none;"
                            ...
                            + " href=\"http://localhost:8080/home/login.jsp\">log in</a>","text/html");
                    Transport.send(m,"your account email","password");//your account email and password
