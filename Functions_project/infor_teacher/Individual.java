 ...
 * @author hoanganhPC
 */
@WebServlet(name = "Individual", urlPatterns = {"/list/individual"})
public class Individual extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("out")!=null){
            ...
            if(request.getSession().getAttribute("id")!=null){
                ControllDao c=new ControllDao();
            c.updatecode((String)request.getSession().getAttribute("id"),request.getParameter("join"));
            response.sendRedirect("/manager/list/individual");}
            else{
                response.sendRedirect("/manager/login.jsp");
            }
        }
