        ...
        if(name!=null&&id!=null&&date!=null&&!name.trim().equals("")&&!date.trim().equals("")&&!id.trim().equals("")){
            ...
            if(t!=null){
                try{
                    ...
                    m.setFrom(new InternetAddress("your account","app Manager Students"));//fill up  your account email
                    m.setRecipients(Message.RecipientType.TO, mail);
                    m.setSubject("recover password");
                    m.setContent("<h1>Your Password: "+pass+"</h1>","text/html");
                    Transport.send(m,"your account","password");//fill up your account email and password
