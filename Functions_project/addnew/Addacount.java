...
public class Addacount extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null || pass == null || campus == null) {
            ...
            try{
            if ((code != null && e != null && n != null) && !(code.trim().equals("") && e.trim().equals("") && n.trim().equals(""))&&checkDate(date)) {
    ...
    private boolean checkDate(String date){
      ...
      return  Pattern.matches("^(0[1-9]|[1-9]|[1-2][1-9]|3[0-1])-(0[1-9]|1[0-2]|[1-9])-([\\d]{4})$", date);
    }
